...
export const animationPresetCapabilities: AnimationPresetCapability[] = [
  ...
  },
  {
    id: 'slide-out-left',
    name: 'Slide Out Left',
    description: 'Slide the scene out to the left edge.',
    direction: 'out',
    supportedPositions: ['left'],
    parameters: {durationFrames: true, intensity: true, easing: true},
    compatibleBlockTypes: ['any'],
  ...
  },
  {
    ...
    description: 'Slide the scene out to the right edge.',
    direction: 'out',
    supportedPositions: ['right'],
    parameters: {durationFrames: true, intensity: true, easing: true},
    compatibleBlockTypes: ['any'],
  ...
  },
  {
    id: 'slide-out-up',
    name: 'Slide Out Up',
    description: 'Slide the scene out upward.',
    direction: 'out',
    supportedPositions: ['up'],
    parameters: {durationFrames: true, intensity: true, easing: true},
    compatibleBlockTypes: ['any'],
  ...
  },
  {
    id: 'slide-out-down',
    name: 'Slide Out Down',
    description: 'Slide the scene out downward.',
    direction: 'out',
    supportedPositions: ['down'],
    parameters: {durationFrames: true, intensity: true, easing: true},
    compatibleBlockTypes: ['any'],
  ...
  },
  {
    id: 'zoom-out',
    name: 'Zoom Out',
    description: 'Scale the scene down to nothing.',
    direction: 'out',
    parameters: {durationFrames: true, intensity: true, easing: true},
    compatibleBlockTypes: ['any'],
    version: '1.0.0',
